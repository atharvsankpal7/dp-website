export const services = {
  ...
  development: {
    ...
    hero: "/services/app-dev-hero.png",
    scene: "/3d/app_dev.splinecode",
    benefits: [
  ...
  reelography: {
    ...
    hero: "/services/reelography-hero.png",
